...
_Step 1_: Create a .env file in this repo's directory. It should look something like this (but with "XXXX" replaced with your user):
...
_Step 2_: Run `npm start` in a terminal
